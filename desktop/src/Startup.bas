...
Public Sub AutoClose()
    ...
    If ActiveWindow.Visible = True Then
        ...
        If Paperless.ActiveSpeechDoc = ActiveDocument.Name Then Paperless.ActiveSpeechDoc = vbNullString
        ...
        #End If
            ...
            If Application.Documents.Count = 1 And Ribbon.RecordAudioToggle = True Then
