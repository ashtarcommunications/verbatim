...
const newSpeech = () => {
	...
	Logger.log(id);
	var html =
		'<script>window.open(`https://docs.doogle.com/document/d/${id}`);google.script.host.close();</script>';
	var html =
		"<script>var link=document.createElement('a');link.href=`https://docs.doogle.com/document/d/${id}`;link.target='_blank';link.click();google.script.host.close();</script>";
