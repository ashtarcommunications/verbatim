...
function createVtub() {
	...
	while (subfolders.hasNext()) {
		...
		while (subsubfolders.hasNext()) {
			...
			vtub[subfolderId][subsubfolderId] = {
				name: subsubfolder.getName(),
				type: 'folder',
				...getFilesInFolder(subsubfolder),
			};
			...
			while (subsubsubfolders.hasNext()) {
				...
				vtub[subfolderId][subsubfolderId][subsubsubfolderId] = {
					name: subsubsubfolder.getName(),
					type: 'folder',
					...getFilesInFolder(subsubsubfolder),
				};
			}
		}
	}
